...
const Input = ({
  ...
  if ((name === undefined && isFormContext) || (name === null && isFormContext)) {
  ...
  const registerFn =
    formContext && isFormContext && formContext.register
          ...
          <>
            ...
            {formContext?.errors[name]?.type === 'pattern' && showError && (
              <>
                ...
                {type !== 'password' && type !== 'tel' && type !== 'email' && type !== 'number' && (
                  <FormAlert>This is invalid.</FormAlert>
                )}
              </>
            )}
