      ...
      <div className="lg:hidden flex mb-8 gap-4 w-full ">
        ...
        <div className="flex flex-col">
          <div className="bg-safekeep-white rounded-[23px] text-[#0150B4] py-1 px-2 font-dmSans font-medium text-sm -tracking-wide">
            {chain?.name}: {truncateWalletAddress(address)}
          </div>
      ...
      <div className="w-full p-8 relative bg-safekeep-white rounded-lg">
        ...
        <div className="mt-9 flex flex-col lg:flex-row gap-4">
          <a
            ...
            className="flex w-full lg:max-w-[197px] gap-2.5 items-center rounded-lg bg-[#0123F7] justify-center p-4 text-safekeep-white font-paralucentMedium text-sm"
          >
            <ArrowDown />
            <p>Deposit Token</p>
          </a>
          <a
            ...
            className="flex w-full lg:max-w-[197px] gap-2.5 rounded-lg border border-solid border-[#0123F7] items-center justify-center p-4 text-safekeep-blue font-paralucentMedium text-sm"
          >
