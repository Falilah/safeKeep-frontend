    ...
    <div>
      <div>
        <div className="text-center max-w-2xl mx-auto  lg:p-0 p-5">
          <div className="text-safe-light-100 bg-safekeep-grey-200 inline-block rounded-3xl lg:py-2 py-4 px-4 lg:text-xl text-lg text-center mx-auto uppercase mb-6">
            What can you do on safekeep
          </div>
          <p className="text-4xl  mx-auto  text-safekeep-blue leading-tight mb-16">
            With Safekeep, You can Trade, Backup, Assign and Inherit Crypto Tokens on the most user-friendly Dashboard.
          </p>
            ...
            <div className="max-w-[13rem] border p-4 rounded-[10px] px-4  text-xl">
              <AnimatedSection>
                <div className=" my-4 mb-8 flex justify-between items-center">
                  ...
                  <div>
                    <button className="bg-safekeep-blue text-safe-light-100 text-xs rounded-full p-1 px-2">
                      coming soon
                    </button>
                  </div>
                </div>
      ...
      <AnimatedSection>
        <div className="text-center max-w-2xl mx-auto  lg:p-0 p-5">
          ...
          <p className="text-4xl hidden lg:block   mx-auto  text-safekeep-blue leading-tight mb-16">
            Looking to Experience safekeep before giving it a shot
          </p>
            ...
            <div className="absolute">
              <div>
                ...
                <div className="max-w-sm border p-8 rounded-[10px] bg-[white] relative box-white z-30 mx-3  ">
                  ...
                  <div className="ext-gray-600">
                    Looking to see how safekeep can help you protect your assets, explore our demo app
                  </div>
                  <div>
                    <Button onlyBtn className="w-full mt-6">
                      View Demo
                    </Button>
                  </div>
                </div>
          ...
          <div id="dash-icon" className="relative hidden md:block">
            <div
              className={`max-w-xs absolute top-1/2 left-1/2 -translate-y-1/2 -translate-x-1/2 bg-safe-light-100 z-50 p-3 px-4 rounded-md transition ${
                showDashTwo ? 'block' : 'hidden'
              }`}
            >
            ...
            <div
              className={`borer relative before:absolute  before:w-full before:left-1/2 before:-translate-x-1/2 before:h-[${
                height - height * 0.16
              }px] z-40 before:content-[''] 
      ...
      <AnimatedSection>
        <div className="text-center max-w-5xl mx-auto ">
          ...
          <p className="text-4xl  mx-auto  text-safekeep-blue leading-tight mb-16">
            Safekeep is the safest, most secure crypto vault to explore web3 without risk.
          </p>
                ...
                <div className="bg-safekeep-blue-100 pl-12 pt-12 rounded-t-2xl">
                  <div className="relative ">
                    ...
                    <div className="absolute  top-1/2 -translate-y-1/2 ">
                      <div className="0">
                        <Image
                          src="transaction-card.svg"
                          className="scale-[0.8] rounded-[8px]"
                          height={550}
                          width={550}
                          alt="dash-img-icon"
                        />
                  ...
                  <div>
                    <AnimatedSection>
                      ...
                      <p className="text-left">
                        Bard is Google's artificial intelligence chatbot. It will work exactly like ChatGPT, that is,
                        users will be able to use the chatbot through conversation.
                      </p>
                    </AnimatedSection>
                  </div>
                  ...
                  <div className="text-safekeep-white ">
                    <AnimatedSection>
                      ...
                      <div className="flex justify-between items-center">
                        <div>
                          {' '}
                          <p className="text-left md:text-base text-xs mb-6">
                            Safekeep supports a wide range of Non-Costodian wallets as well as ERC-20 Tokens.
                          </p>
                        </div>
              ...
              <div className="flex  justify-center lg:justify-start">
                <AnimatedSection className="flex">
                  <Image
                    ...
                    width={150}
                    height={400}
                    src="./assets-home-dash-left.svg"
                    alt="assets-home-dash-left"
                  />
                  ...
                  <Image
                    ...
                    width={150}
                    height={400}
                    src="./assets-home-dash-right.svg"
                    alt="assets-home-dash-rights"
                  />
                </AnimatedSection>
              </div>
              <div className=" ">
                <AnimatedSection>
                  ...
                  <div className="flex justify-between items-center">
                    <div>
                      {' '}
                      <p className="text-left py-4 text-md">
                        Safekeep provides unparalleled transparency, giving you a clear view of your Vault and
                        transactions.
                      </p>
                    </div>
                    <div>
